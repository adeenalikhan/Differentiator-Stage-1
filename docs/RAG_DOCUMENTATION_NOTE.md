<!-- This is the RAG documentation note (Task 1 deliverable). It is a verbatim copy of the
in-repo file rag/app/README.md, placed in docs/ so it can be attached to the submission.
The repo copy at rag/app/README.md is authoritative. -->

# Family Office Intelligence — Micro-RAG (documentation note)
