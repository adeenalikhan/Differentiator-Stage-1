...
**1. Approximate build time.** Roughly 9 to 10 hours of active work across four sessions,
...
- Task 2 (conversion): the core insight, that the moat is offline-sourced single-family-office
  data, was mine; the AI sharpened it into a diagnosis-first answer with defensible confidence.
